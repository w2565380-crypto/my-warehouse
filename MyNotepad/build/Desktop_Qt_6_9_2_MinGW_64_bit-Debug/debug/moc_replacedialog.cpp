...
template <> constexpr inline auto ReplaceDialog::qt_create_metaobjectdata<qt_meta_tag_ZN13ReplaceDialogE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "",
        "btReplace_clicked",
        "btReplaceAll_clicked",
        "btCancel_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'btFindNext_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'btReplace_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'btReplaceAll_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'btCancel_clicked'
...
void ReplaceDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->btFindNext_clicked(); break;
        case 1: _t->btReplace_clicked(); break;
        case 2: _t->btReplaceAll_clicked(); break;
        case 3: _t->btCancel_clicked(); break;
        default: ;
        }
    }
    (void)_a;
